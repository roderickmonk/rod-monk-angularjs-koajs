...
angular.module('ttc')
	.controller('NewsCtrl', ['$scope', 'NewsItemService', '$window', ($scope, NewsItemService, $window) => {
...
angular.module('ttc')
	.controller('NewsItemFilesController', ['$scope', 'NewsItemService', ($scope, NewsItemService) =>
